...
SEARCH_QUERY_PREFIX = 'donald trump since:2015-12-16 since_id:'
SEED_TWEET_FILE = 'TrumpTweetsSeq532.txt'
SEED_TWEET_FILE_COUNTER_START = 532
SEED_TWEET_FILE_PREFIX = 'TrumpTweetsSeq'
SEED_TWEET_FILE_SUFFIX = '.txt'
NUMBER_OF_FILES_TO_COLLECT = 640
