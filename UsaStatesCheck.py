...
state_codes = ['al','ak','az','ar','cf','cl','ct','dl','fl','ga','ha','id','il','in','ia','ka','ky','la','me','md','ms','mc','mn','mi','mo','mt','nb','nv','nh','nj','nm','ny','nc','nd','oh','ok','or','pa','ri','sc','sd','tn','tx','ut','vt','va','wn','wv','ws','wy'];
